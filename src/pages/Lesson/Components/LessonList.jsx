...
const LessonList = ({ lessons, activeLesson, onLessonClick, progress }) => {
  return (
      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden">
        <div className="p-6 border-b">
          ...
          <div className="mt-2 flex items-center justify-between">
            ...
            <div className="text-sm font-medium">{lessons.length} lessons</div>
          </div>
        ...
        <div className="divide-y max-h-[600px] overflow-auto">
          {lessons.map((lesson) => (
            ...
            >
              ...
              {lesson.locked && <Lock className="h-4 w-4 text-gray-400 ml-2" />}
