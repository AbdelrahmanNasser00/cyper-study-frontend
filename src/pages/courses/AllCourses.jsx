...
function AllCourses() {
  ...
  const { data: allCourses, isLoading, error } = useGetAllCoursesQuery();
    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-15">
        <div className="container">
          ...
          {/* end menu */}
          <h2 className="py-5 font-bold text-4xl">All Courses</h2>
      ...
      <div className="flex gap-5 container my-10 relative">
        {/* start filter */}
        {isOpen && (
          <div className="w-60 rounded-2xl shrink-0 bg-gray-50 shadow-black shadow-2xl p-10">
            {/* start rating */}
            <div className="mb-8">
            ...
            <div className="mb-8">
              ...
              {["beginner", "intermediate", "advanced"].map((level) => (
                <div key={level} className="flex items-center mb-2">
                  ...
                  />
                  <Label htmlFor={`level-${level}`} className="ml-2 capitalize">
                    {level}
                  </Label>
                </div>
              ))}
